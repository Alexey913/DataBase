...
## [Семинар 5 - SQL – оконные функции](Les5)
### [Задание 1](Les5/cte.sql)
Таблицы для работы созданы в файле задания
...
### [Задание 2](Les5/win_func.sql)
[Таблица для работы](Les5/img4165156498465354.png)
...
## [Домашнее задние 5](Les5/homework5.sql)
### Задание 1
[Таблица для работы](Les5/img41651564984651312.png)
1. Создайте представление, в которое попадут автомобили стоимостью до 25 000 долларов
2. Изменить в существующем представлении порог для стоимости: пусть цена будет до 30 000 долларов (используя оператор ALTER VIEW)
3. Создайте представление, в котором будут только автомобили марки “Шкода” и “Ауди”
### Задание 2
[Таблица для работы](Les5/img41651564984651321.png)
...
[Создание таблиц для работы](Les6/lesson_6.sql)
### [Задание 1](Les6/procedure.sql)
Создайте процедуру, которая выберет для одного пользователя 5 пользователей в случайной комбинации, которые удовлетворяют хотя бы одному критерию
1. Из одного города
2. Состоят в одной группе
3. Друзья друзей
### [Задание 2](Les6/function.sql)
Создание функции, вычисляющей коэффициент популярности пользователя (по заявкам на дружбу таблица friend_requests)
### [Задание 3](Les6/cycle.sql)
Необходимо перебрать всех пользователей и тем пользователям, у которых дата рождения меньше определенной даты обновить дату рождения на сегодняшнюю дату (реализация с помощью цикла)

## [Домашнее задние 6](Les6/homework6.sql)
База данных для работы созданы в файле задания
